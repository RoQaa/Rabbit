...
public class ImagesMethods extends RabbitGLEventListener {
    static int maxWidth = 1500, maxHeight = 900;



    public static void DrawRabbitInHole(GL gl, int x, int y, int index, float scale) {
    ...
    public static void DrawDizzyRabbit(GL gl, int x, int y, int index, float scale) {
        gl.glEnable(GL.GL_BLEND);
    ...
    public static void DrawHammer(GL gl, int x, int y, int index, float scale) {
        gl.glEnable(GL.GL_BLEND);
    ...
    public static void DrawParentBackground(GL gl,int index) {
